...
2. Versionado y evolución de eventos: *Tolerant Reader* y *Upcasters* para consumir `v1`/`v2` sin romper el sistema.
3. RabbitMQ en Node.js: exchanges, colas, bindings, `ack`/`nack`, `prefetch` y dónde instrumentar (bordes).
